   ...
   begin
      with UserDataForm do
         begin
            ...
            CitationEdit.Text := User_data_set_info.data_set_citation;
...
procedure TUserDataForm.CitationEditChange(Sender: TObject);
begin
   User_data_set_info.data_set_citation := CitationEdit.txt;
end;
