...
/* This is a power analysis for a BACI design with multiple years (fish monitoring) */
...
title 'Fish example BACI power analysis';
ods pdf file='baci-fish-power-SAS.pdf';
...
ods tagsets.mycolorlatex file='baci-fish-power-SAS-500.tex' (notop nobot) stylesheet="sas.sty";
