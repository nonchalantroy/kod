# Example 7.7 and Figures 7.8 and 7.9
...
t2=proc.time()
(t2[3]-t1[3])/60^2  # elapsed time in hours

postscript("CRSPSkewTBootAlpha.ps",width=6,height=5) # Fig 7.9
par(mfrow=c(2,2))
...
postscript("CRSPNormalPlots.ps",width=6,height=5) # Fig 7.8
par(mfrow=c(2,2))
