#  Example 14.4 and Figures 14.5, 14.6, 14.9
...
postscript("DefaultProb.ps",width=8,height=4)  #  Figure 14.5
par(mfrow=c(1,2))
...
postscript("DefaultProbResid1.ps",width=7,height=3.5) #  Figure 14.6
par(mfrow=c(1,2))
...
postscript("DefaultProbResid2.ps",width=7,height=3.5)  # Figure 14.9
par(mfrow=c(1,2))
