...
class Account(SystemStage):
    ...
    def pandl_for_subsystem(
        ...
        def _pandl_for_subsystem(
            ...
            print(__file__ + " " + "Calculating pandl for subsystem for instrument %s" % instrument_code)
    ...
    def get_buffered_position(self, instrument_code, roundpositions=True):
        ...
        def _get_buffered_position(
            ...
            print(__file__ + " " + "Calculating buffered positions")
    ...
    def pandl_for_instrument(
        ...
        def _pandl_for_instrument(
            ...
            print(__file__ + " " + "Calculating pandl for instrument for %s" % instrument_code)
    ...
    def pandl_for_trading_rule(self, rule_variation_name, delayfill=True):
        ...
        def _pandl_for_trading_rule(
            ...
            print(__file__ + " " + "Calculating pandl for trading rule %s" % rule_variation_name)
    ...
    def pandl_for_trading_rule_unweighted(self, rule_variation_name, delayfill=True):
        ...
        def _pandl_for_trading_rule_unweighted(
            ...
            print(__file__ + " " + "Calculating pandl for trading rule (unweighted) %s" % rule_variation_name)
    ...
    def pandl_for_instrument_rules_unweighted(self, instrument_code, rule_list=None, delayfill=True):
        ...
        def _pandl_for_instrument_rules_unweighted(
            ...
            print(__file__ + " " + "Calculating pandl for instrument rules for %s" % instrument_code)
    ...
    def pandl_for_instrument_forecast_weighted(
        ...
        def _pandl_for_instrument_forecast_weighted(system, instrument_code, 
            ...
            print(__file__ + " " + "Calculating pandl for instrument forecast weighted for %s %s" % (instrument_code, rule_variation_name))
    ...
    def pandl_for_instrument_forecast(
        ...
        def _pandl_for_instrument_forecast(system, instrument_code, 
            ...
            print(__file__ + " " + "Calculating pandl for instrument forecast for %s %s" % (instrument_code, rule_variation_name))
    ...
    def pandl_for_all_trading_rules(self, delayfill=True):
        ...
        def _pandl_for_all_trading_rules(
            ...
            print(__file__ + " " + "Calculating pandl for all trading rules")
    ...
    def pandl_for_all_trading_rules_unweighted(self, delayfill=True):
        ...
        def _pandl_for_all_trading_rules_unweighted(
            ...
            print(__file__ + " " + "Calculating pandl for all trading rules unweighted")
    ...
    def portfolio(self, delayfill=True, roundpositions=True):
        ...
        def _portfolio(system, not_used, this_stage,
            ...
            print(__file__ + " " + "Calculating pandl for portfolio")
            capital=this_stage.get_notional_capital()
            instruments = this_stage.get_instrument_list()
            port_pandl = [
    ...
    def get_buffered_position_with_multiplier(self, instrument_code, roundpositions=True):
        ...
        def _get_buffered_position_with_multiplier(
            ...
            print(__file__ + " " + "Calculating buffered positions with multiplier")
    ...
    def pandl_for_instrument_with_multiplier(
        ...
        def _pandl_for_instrument_with_multiplier(
            ...
            print(__file__ + " " + "Calculating pandl for instrument for %s with capital multiplier" % instrument_code)
