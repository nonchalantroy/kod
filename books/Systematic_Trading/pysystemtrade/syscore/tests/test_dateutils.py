...
class Test(ut.TestCase):
    ...
    def test_data(self):
        x = pd.DataFrame(dict(CARRY_CONTRACT=["", "201501", "", "201501", "20150101", "20150101", "201501"],
                              PRICE_CONTRACT=["", "", "201504", "201504", "201504", "20150115", "201406"]))
    ...
    def test_expiry_diff(self):
        ...
        expected = [-0.24640657084188911, -0.24640657084188911, -
                    0.054757015742642023, 0.58590006844626963]
